...
public:
	std::vector< svec3d > vertices;
	std::vector< svec4<int> > elements;
};
...
{
	DAnsiStr strFilePath(lpInputNodeFile);
	DAnsiStr strExt = ExtractFileExt(strFilePath);
	if(strExt != "node")
		return -1;

	DAnsiStr strElementFP = ChangeFileExt(strFilePath, ".ele");
	MeshReader mesh;
	...
	//Output veg file
	DAnsiStr strVegFP = ChangeFileExt(strFilePath, ".veg");
