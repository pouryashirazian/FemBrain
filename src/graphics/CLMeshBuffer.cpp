...
bool CLMeshBuffer::ReadbackMeshVertexAttribCL(ComputeDevice* lpDevice,
	...
	//Vertices
	cl_mem outMemMeshVertices = lpDevice->createMemBufferFromGL(lpBuffer->vertexBufferObjectGL(attrib), PS::CL::memReadOnly);
...
bool CLMeshBuffer::ReadbackMeshFaceCL(ComputeDevice* lpDevice,
	...
	//Vertices
	cl_mem outMemMeshFaces = lpDevice->createMemBufferFromGL(lpBuffer->indexBufferObjectGL(), PS::CL::memReadOnly);
